 ...
 const isSelected =  selectedCatagory.some((v)=>(
  ...
  return (
    <li
      ...
      className={`text-base max-sm:text-sm cursor-pointer flex items-center gap-2 font-medium text-black rounded-lg px-4 py-2 max-sm:py-1 ${
        activeCatagory 
          ? "bg-blue-600 border-purple-300 border-2"
          : "bg-blue-400"
      } `}
    >
